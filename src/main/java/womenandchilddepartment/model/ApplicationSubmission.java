...
public class ApplicationSubmission {
	...
	public ApplicationSubmission(int apsi, String areYouADepttCandidate, String organizationName,
			String yearsOfExperience, String natureOfWorksPerformed, String picture, String signature,
			String tenthExamMarkSheet_Certificate, String adressProof, String lastYearMarksheet, String workExperience,
			String anyOtherDoc) {
		super();
		this.apsi = apsi;
		this.areYouADepttCandidate = areYouADepttCandidate;
